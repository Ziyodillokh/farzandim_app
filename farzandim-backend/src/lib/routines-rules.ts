// Routines: Tashkent (UTC+5, DST yo'q) vaqt va vaqt oynasi tekshiruvlari.
// Sof funksiyalar — test qilish oson.
...
/**
 * Tashkent (UTC+5, no DST) hozirgi vaqt + ISO 8601 weekday (1=Mon, 7=Sun).
...
/**
 * Vaqt oynasi nowMin'ni o'rab oladimi tekshirish.
 * Wrap-around qo'llab-quvvatlanadi (masalan, 22:00 → 06:00 uxlash).
 */
