  ...
  static const List<LegalSection> privacyPolicy = [
    ...
    LegalSection(
      ...
      'Ilova quyidagi tashqi xizmatlardan foydalanadi:\n\n'
          '   • Firebase (Google LLC): autentifikatsiya, Firestore '
          'ma\'lumotlar bazasi, Cloud Storage, Cloud Messaging '
          '(bildirishnomalar), Cloud Functions, Crashlytics, Analytics, '
          'App Check\n'
          '   • Google Maps Platform: xaritalarni vizualizatsiya qilish, '
          'geokodlash\n'
    ...
    LegalSection(
      ...
      'Ma\'lumotlar quyidagi texnik vositalar bilan himoyalangan:\n\n'
          ...
          '   • AES-256 shifrlash (Firebase tomonidan, dam olishda)\n'
          '   • Firestore Security Rules (har bir so\'rov '
          'serverda tekshiriladi)\n'
          '   • Firebase Auth (Phone OTP — SMS orqali)\n'
  ...
  static const List<LegalSection> termsOfService = [
    ...
    LegalSection(
      ...
      'Foydalanuvchi istalgan vaqtda o\'z akkountini va barcha '
          ...
          'tashlanadi\n'
          '   • Firebase Auth foydalanuvchi yozuvi o\'chiriladi\n\n'
