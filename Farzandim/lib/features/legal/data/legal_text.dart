  ...
  static const List<LegalSection> privacyPolicy = [
    ...
    LegalSection(
      ...
      'Biz quyidagi turdagi ma\'lumotlarni yig\'amiz:\n\n'
          ...
          'aniqlash uchun)\n'
          '   • Ota-onaning o\'z joylashuvi — FAQAT xaritada "mening '
          'joylashuvim" tugmasi bosilganda (fonda kuzatilmaydi)\n'
          '   • Ovozli va video xabarlar — mikrofon/kamera orqali, faqat '
          'siz yozganingizda va faqat o\'z farzandingiz bilan yozishish '
          'uchun\n'
          '   • Obuna holati (tarif, muddat). Karta ma\'lumotlari BIZDA '
          'SAQLANMAYDI — ular to\'lov provayderi tomonida ishlanadi\n\n'
