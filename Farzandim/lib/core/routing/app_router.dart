...
import 'package:farzandim/features/app_restrictions/presentation/screens/control_policy_screen.dart';
...
List<RouteBase> buildAppRoutes() {
  return <RouteBase>[
    ...
    GoRoute(
      path: AppRoutes.controlPolicyPattern,
      pageBuilder: (context, state) => _slidePage(
        ControlPolicyScreen(childId: state.pathParameters['childId']!),
      ),
    ),
    GoRoute(
