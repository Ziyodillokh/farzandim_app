// ─────────────────────────────────────────────────────────────────────
// chat_wallpaper_provider — chat orqa foni (Parent App'dan port)
// ─────────────────────────────────────────────────────────────────────
//
// Tanlov SharedPreferences'da saqlanadi (barcha chatlar uchun bitta).
// Format (raw string):
//   'default'   → ilovaning standart foni (GradientBackground)
...
/// Tayyor gradient fonlar — Telegram uslubidagi premium ranglar.
