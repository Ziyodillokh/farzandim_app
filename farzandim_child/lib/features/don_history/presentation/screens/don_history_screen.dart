// ─────────────────────────────────────────────────────────────────────
// DonHistoryScreen — "DON tarixi" (bola DON'i qayerdan yig'ilgan)
// ─────────────────────────────────────────────────────────────────────
//
// DON reytingi (RankingScreen) header'idagi tarix ikonasidan ochiladi.
...
class DonHistoryScreen extends ConsumerWidget {
  const DonHistoryScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(donHistoryProvider);
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // Ulush bar (manba jami DON'ning necha % qismi).
                ClipRRect(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 10),
          Text('+${_fmtNum(entry.don)}', style: _unb(15, c: const Color(0xFF34C759))),
        ],
      ),
    );
  }
